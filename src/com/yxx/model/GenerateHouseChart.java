...
*
*/
public class GenerateHouseChart{
	...
	private static XYDataset createDataset(String username) {
		...
		HomeDecisionOperation dbo = new HomeDecisionOperation();
...
//	public static void main(String[] args){
	...
	try {
		ChartUtilities.saveChartAsJPEG(new File("E:/EnergyService/EnergyService/WebRoot/img/houselineChart.jpg"), j, 800, 600);
	} catch (IOException e) {
