	...
	<div id="main">
	 <form id="infoForm" method="post">
		...
		<table id="search" class="table">
			...
			<td  align="center"><input name="password" id="password" type="text" value="<%=ub.getPasswd() %>"/></td>
	  		</tr>
			...
			<td  align="center"><input name="email" id="email" type="text" value="<%=ub.getEmail() %>"/></td>
	  		</tr>
		</tbody>
		</table>
		...
		<table id="search" class="table">
			...
			<td  align="center"><input name="homeaddr" type="text" value="<%=ub.getHomeaddr() %>"/></td>
	  		</tr>
			...
			<tr style="border: 0px"><td  align="center"><input name="dailydestination" type="text" value="<%=workingaddrs[i] %>"/></td></tr>
			<%} %>
			<tr style="border: 0px">
			<td>
			...
			<tr style="border: 0px"><td  align="center"><input name="dailydestination" type="text" value="<%=meetingaddrs[i] %>"/></td></tr>
			<%} %>
			<tr style="border: 0px">
			<td>
			...
			<tr style="border: 0px"><td  align="center"><input name="dailydestination" type="text" value="<%=leisureaddrs[i] %>"/></td></tr>
			<%} %>
			<tr style="border: 0px">
			<td>
			...
			<tr style="border: 0px">
			<td  align="center"><input id="dailydestination" name="dailydestination" type="text" value="<%=frequentaddrs[i] %>"/></td>
			</tr>
			<% } %>
			<tr style="border: 0px">
			<td>
