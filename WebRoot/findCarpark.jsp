...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">  
	<head>
		...
		<script type="text/javascript" src="js/findcarpark.js"></script>
	...
	<div id="posts">
		...
		<!-- single-post -->
		<div class="post">
			<p class="post-title custom">FIND A CARPARK</p>
			<div class="post-img"><img src="img/carpark.png" alt="Image" /></a><span></span></div>
		</div>
		<!-- ENDS single-post -->
		...
		<div class="contact-left">
			<h5 class="custom">INPUT THE ADDRESS/POSTCODE:</h5>
				<fieldset>
					<p><input id="address" type="textbox" placeholder="Search Box" width="300px" ><a class="text" id="departure-link" href="#">Get my position</a></p>	
					<p><input type="button" value=" " name="send" id="send" onclick="show()"/></p>
