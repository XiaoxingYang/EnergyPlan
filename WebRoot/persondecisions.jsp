...
<html xmlns="http://www.w3.org/1999/xhtml"  xml:lang="en" lang="en">  
	...
	<div id="main">
	    ...
	    <table id="searchresult"   class="table">
	    	...
	    	<td style="width: 50px" align="center">DecisionId</td>
    		<td style="width: 180px" align="center">Departure</td>
    		<td style="width: 180px" align="center">Destination</td>
    		<td style="width: 100px" align="center">DepartureTime</td>
			<td style="width: 100px" align="center">ArriveTime</td>
    		<td style="width: 80px" align="center">Vehicle</td>
    		<td style="width: 80px" align="center">Carbon</td>
    		</tr>
	    	</thead>
	    	<tbody>
	    	<%
    			for(int i = 1; i<=al.size();i++){
   					DecisionBean tb = (DecisionBean)al.get(i-1);
	    			%>
	    			<tr align="center">
	    			<td align="center"><%=tb.getDecisionId() %></td>
					<td align="center"><%=tb.getDeparture() %></td>
   					<td align="center"><%=tb.getDestination() %></td>
   					<td align="center"><%=tb.getDepartureTime() %></td>
					<td align="center"><%=tb.getArriveTime() %></td>
   					<td align="center"><%=tb.getVehicle() %></td>
	        ...
	        <%
		   	  ...
		   	  if(pageNow!=1){
			   	  out.print("<a href=ShowAllDecisionServlet?pageNow="+(pageNow-1)
			   	 +">previous</a>&nbsp");
		   	  }
		   	  
		   	  for(int i =1;i<=pageCount;i++){
			   	  out.print("<a href=ShowAllDecisionServlet?pageNow="+i
			   	  +">"+i+"</a>&nbsp");
		   	  }
