...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">  
	...
	<div id="posts">
		...
		<!-- single-post -->
		<div class="post">
			<p class="post-title custom">PLAN A CAR ROUTE</p>
			<div class="post-img"><img src="img/carroute.jpg" alt="Image" /></a><span></span></div>
		</div>
		<!-- ENDS single-post -->
			...
			<form action="SaveSessionServlet" method="post">
				<fieldset>
					...
					<p>
					    ...
					    <option value="Fuel Economic">Fuel Economic</option></select>Journey</label>
					</p>
