	...
	<div id="main">
	    ...
	    <table id="searchresult" border="1" width="960" align="left" class="table">
	        ...
	        <%
		   	  ...
		   	  if(pageNow!=1){
			   	  out.print("<a href=ShowAllOptionServlet?pageNow="+(pageNow-1)
			   	  +"&departure="+session.getAttribute("departure")+"&destination="+
			   	  session.getAttribute("destination")+">previous</a>&nbsp");
		   	  }
		   	  
		   	  for(int i =1;i<=pageCount;i++){
			   	  out.print("<a href=ShowAllOptionServlet?pageNow="+i
			   	  +"&departure="+session.getAttribute("departure")+"&destination="+
			   	  session.getAttribute("destination")+">"+i+"</a>&nbsp");
		   	  }
		   	  
		   	  if(pageNow!=pageCount){
			   	  out.print("<a href=ShowAllOptionServlet?pageNow="+(pageNow+1)
			   	  +"&departure="+session.getAttribute("departure")+"&destination="+
			   	  session.getAttribute("destination")+">next</a>&nbsp");
		   	  }
		   	  %>
		</div>
